	...
	<div class="container mx-auto px-4 sm:px-8">
		<div class="py-8">
			<div class="flex items-center justify-between">
				<h2 class="text-2xl font-semibold leading-tight text-white">Data Alternatif</h2>
							...
							<tr>
								...
								<td class="px-5 py-5 border-b border-gray-700 bg-gray-600 text-gray-300 text-sm">
									<div class="flex items-center justify-end gap-4">
										<a href="{{ route('alternatif.edit', $alt->id) }}" class="uppercase font-medium text-xs text-gray-300">Ubah</a>
