<div id="ranking">
	...
	<div class="container mx-auto px-4 sm:px-8">
		<div class="py-8">
			...
			<p class="text-white">Data berikut diurutkan berdasarkan nilai tertinggi.</p>
				...
				<div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
					<table class="min-w-full leading-normal">
						...
						<tbody>
							...
							<tr>
								<td class="px-5 py-5 border-b border-gray-700 bg-gray-600 text-sm" colspan="{{ $kriterias->count() + 4 }}">Belum ada data alternatif.</td>
							</tr>
